...
exports.insertWinnerSMS = (req, res) =>
  mobilesService.findRunningRaffle(req.params.keyword)
    .then((foundTime) => {
      console.log('1st then() insertwinnersms');
      if (foundTime) {
    ...
    .then((promises) => {
      console.log('2nd then() insertwinnersms');
    ...
    .then((mobiles) => {
      console.log('3rd then() insertwinnersms');
    ...
    .then((mobiles) => {
      console.log('4th then() insertwinnersms');
...
function handleErrors(response) {
  if (!response.ok) {
    console.log('handleErrors: ', response.statusText);
